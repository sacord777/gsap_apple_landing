...
import ModelSwithcer from "./three/ModelSwithcer.jsx"
import { useMediaQuery } from "react-responsive"

const ProductViewer = () => {
    const {color, scale, setColor, setScale} = useMacbookStore()

    const isMobile = useMediaQuery({ query: '(max-widht: 1024px)' })
    ...
    return (
        <section id='product-viewer'>
            ...
            <div className='controls'>
                <p className='info'>MacBookPro 14" or 16" and in Silver or Space Gray</p>
